...
var ajax = {
    ...
    get: function (options) {
        // toast.show("加载中");
        if (!localStorage.getItem('loginID') && location.pathname.indexOf("login/index") == -1 && location.pathname.indexOf("register/index") == -1 && location.pathname.indexOf("member/invite") == -1 && location.pathname.indexOf("login/password") == -1) {
