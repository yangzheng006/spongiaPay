        ...
        show:function () {
            ...
            for (var i = 0; i < this.data.length; i++) {
                ...
                if (tNum==0){
                    ...
                    if(this.data[i].url == "" || this.data[i].url == null){
                        // str += '<div class="channel__item"><a href="../channel/index.html?id='+ this.data[i].id +'" data-id="'+ this.data[i].id +'"> ';
                        if(this.data[i].name == "更多课程"){
                            str += '<div class="channel__item"><a href="../category/index.html" data-id="'+ this.data[i].id +'"> ';
                        }else{
                            str += '<div class="channel__item"><a href="../search/productReasult.html?categoryId='+ this.data[i].id +'&categoryName=' + escape( this.data[i].name)+ '&type=category" data-id="'+ this.data[i].id +'"> ';
                        }
                    }else{
                        str += '<div class="channel__item"><a href="'+ this.data[i].url +'" data-id="'+ this.data[i].id +'">';
                    }
